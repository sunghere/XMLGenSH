...
public class ScreenUtil {
    ...
    public static void generatorXML(String path, String orgName) {
        Thread geneThread=null;
        try {
            geneThread = new GeneratorThread(path, orgName);
            geneThread.start();
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            if(geneThread !=null) geneThread.interrupt();
        }
